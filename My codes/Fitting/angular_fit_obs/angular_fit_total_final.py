...
# Plot the results
import b2kstll
b2kstll.plot.plot_distributions_using_partial_integrals(model=pdf_tot, data=zdata, suffix="test_lhcb")
# b2kstll.plot.plot_distributions(model=pdf_tot,data=zdata, suffix="test_lhcb")

# (model=pdf_tot, data = zdata, suffix ="test_lhcb")